                ...
                <div class="col-sm-6">
                    <div class="action-buttons faded">
                        ...
                        @if(userCan('page-create', $book))
                            <a href="{{ $book->getUrl('/page/create') }}" class="text-pos text-button" style="display:inline-block;color:#fff;padding:1px 7px;background:#7C8F99 bottom left repeat-x;font-weight:bold;text-shadow:0 1px 0px rgba(0, 0, 0, 0.5);text-decoration:none;-moz-border-radius:3px;border-radius:3px;text-align:center;box-shadow:0 2px 2px rgba(0, 0, 0, 0.2);-moz-box-shadow:0 2px z2px rgba(0, 0, 0, 0.2);-webkit-box-shadow:0 2px 2px rgba(0, 0, 0, 0.2)"><i class="zmdi zmdi-plus"></i>{{ trans('entities.pages_new') }}</a>
                        @endif
                        @if(userCan('chapter-create', $book))
                            <a href="{{ $book->getUrl('/chapter/create') }}" class="text-pos text-button" style="display:inline-block;color:#fff;padding:1px 7px;background:#7C8F99 bottom left repeat-x;font-weight:bold;text-shadow:0 1px 0px rgba(0, 0, 0, 0.5);text-decoration:none;-moz-border-radius:3px;border-radius:3px;text-align:center;box-shadow:0 2px 2px rgba(0, 0, 0, 0.2);-moz-box-shadow:0 2px z2px rgba(0, 0, 0, 0.2);-webkit-box-shadow:0 2px 2px rgba(0, 0, 0, 0.2)"><i class="zmdi zmdi-plus"></i>{{ trans('entities.chapters_new') }}</a>
                        @endif
